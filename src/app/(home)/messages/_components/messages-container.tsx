...
export function MessagesContainer() {
  ...
  const handleNewMessageClick = React.useCallback(() => {
    setShowNewMessageModal(true);
  }, []);

  const handleUserSelect = React.useCallback((conversationId: string) => {
    setSelectedConversationId(conversationId);
  }, []);
              ...
              <div className="flex h-full items-center justify-center bg-background">
                <div className="text-center">
                  ...
                  <button
                    ...
                    className="inline-flex items-center justify-center rounded-lg bg-primary px-6 py-2 text-sm font-medium text-primary-foreground transition-colors hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50"
                  >
                    Send message
                  </button>
                </div>
